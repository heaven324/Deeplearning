...
#데이터 로드
train_image = "C:\\Users\\heaven\\python_project\\test_data\\total_image_64"
train_label = "C:\\Users\\heaven\\python_project\\test_data\\label1.csv"
test_image  = "C:\\Users\\heaven\\python_project\\test_data\\test_image_64"
...
W4 = tf.get_variable(name='W4', shape=[8*8*512, 1024], initializer=tf.contrib.layers.variance_scaling_initializer())
y4 = tf.reshape(y3_2, [-1, 8*8*512])
...
with tf.Session() as sess:
    ...
    for j in range(300):
        ...
        for i in range(66*4):
            train_xs, train_ys = loader3.next_batch(trainX, trainY, i*25, i*25+25)
            test_xs, test_ys = loader3.next_batch(testX, testY, i*25, i*25+25)
