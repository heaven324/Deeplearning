...
test_image  = "C:\\Users\\heaven\\python_project\\test_data\\total_image_32_part\\test400"
test_label  = "C:\\Users\\heaven\\python_project\\test_data\\total_image_32_part\\label400.csv"
...
#출력층
b6 = tf.Variable(tf.ones([4]))
W6 = tf.get_variable(name='W6', shape=[1024, 4], initializer=tf.contrib.layers.variance_scaling_initializer()) # he 초기값
...
# 라벨을 저장하기 위한 변수 생성
y_onehot = tf.placeholder("float",[None,4])
    ...
    for j in range(300):
        ...
        for i in range(19):
            ...
            if i == 0:
                ...
                print(str(j + 1)+' 훈련 : ', train_acc, ', 테스트 : ', test_acc)
                print('-----------------------------------------------')
